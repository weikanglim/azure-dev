...
import (
	...
	"github.com/azure/azure-dev/cli/azd/test/recording/mock"
...
var packagePath = "cli/azd/test/recording/testdata"
...
func TestRecordingAssetConfig(t *testing.T) {
	cases := []struct{ expectedDirectory, searchDirectory, testFileLocation string }{
		{"cli/azd/test/recording", "cli/azd/test/recording", recordingAssetConfigName},
		{"cli/azd/test/recording", "cli/azd/test/recording/", recordingAssetConfigName},
		{"cli/azd/test", "cli/azd/test/recording", "../" + recordingAssetConfigName},
		{"cli/azd/test", "cli/azd/test/recording/", "../" + recordingAssetConfigName},
	}
